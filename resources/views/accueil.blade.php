                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="tour_search_form">
                                        <form action="#!">
                                            <div class="row">
                                                <div class="col-lg-15 col-md-12 col-sm-12 col-12">
                                                    <div class="flight_Search_boxed">
                                                        <p>Destination</p>
                                                        <input
                                                            type="text"
                                                            placeholder="Ou voulez vous allez ?" />
                                                    </div>
                                                </div>
                                                ...
                                                <form action="#!">
                                                    <div class="row">
                                                        <div class="col-lg-3 col-md-6 col-sm-12 col-12">
                                                            <div class="flight_Search_boxed">
                                                                <p>Départ</p>
                                                                <input type="text" name="form_ville_depart" value="New York" />
                                                        ...
                                                        <div class="col-lg-3 col-md-6 col-sm-12 col-12">
                                                            <div class="flight_Search_boxed">
                                                                <p>Arriver</p>
                                                                <input type="text" name="form_ville_arriver" value="London " />
                                                                <div class="plan_icon_posation">
                                                            ...
                                                            <div class="flight_Search_boxed dropdown_passenger_area">
                                                                ...
                                                                <div class="dropdown">
                                                                    ...
                                                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                                                        ...
                                                                        <li><a class="dropdown-item" href="#" data-value="{{ $categorie }}">{{ $categorie }}</a></li>
                                                                        @endforeach
                                                                    </ul>
                                                                </div>
                                                                                    ...
                                                                                    <div class="cabin-selection">
                                                                                        ...
                                                                                        <div class="cabin-list">
                                                                                            ...
                                                                                            <button
                                                                                                ...
                                                                                                class="label-select-btn">
                                                                                                <span
                                                                                                    class="MuiButton-label">First Class
                                                                                                </span>
                                                                                            </button>
                                                                                        </div>
                                                                                    </div>
